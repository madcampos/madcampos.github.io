...
export const SITE_TITLE_STRING = 'Marco Campos — Senior Web Developer';
...
export const ERROR_TITLE = ['404', ...SITE_TITLE];
export const ERROR_TITLE_STRING = '404 — Not Found';
export const ERROR_DESCRIPTION = '404 — Not Found';

export const OFFLINE_URL = '/offline';
export const OFFLINE_TITLE = ['Offline Page', ...SITE_TITLE];
export const OFFLINE_TITLE_STRING = 'Offline Page';
export const OFFLINE_DESCRIPTION = 'Marco Campos — Offline Page';

// "Blog" constants
export const BLOG_URL = '/blog';
export const BLOG_TITLE_STRING = "Marco Campos' Blog";
export const BLOG_TITLE = ['Blog', ...SITE_TITLE];
export const BLOG_DESCRIPTION = "Marco Campos' Blog — A space where I talk about web development and other programming related (or not) things.";
...
// "Blog tags list" constants
export const BLOG_TAGS_URL = `${BLOG_URL}/tags`;
export const BLOG_TAGS_TITLE_STRING = "Tags for Marco Campos' blog";
...
export const TALKS_TITLE_STRING = 'Talks, Presentations & Workshops';
export const TALKS_DESCRIPTION = "Marco Campos' Talks — A list of talks I've given on meetups, conferences, or other events.";
